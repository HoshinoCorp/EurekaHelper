...
namespace Dalamud
{
    public class DalamudApi
    {
        ...
        public static DalamudApi operator +(DalamudApi container, object o)
        {
            ...
            {
                if (f.PropertyType != o.GetType())
                    continue;
                if (f.GetValue(container) != null)
                    break;
    ...
    public class PluginCommandManager<T> : IDisposable
        where T : IDalamudPlugin
    {
        ...
        {
            var handlerDelegate = (IReadOnlyCommandInfo.HandlerDelegate)
