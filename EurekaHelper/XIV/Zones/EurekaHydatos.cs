...
namespace EurekaHelper.XIV.Zones
{
    public class EurekaHydatos : IEurekaTracker
    {
        ...
        public EurekaHydatos(List<EurekaFate> fates)
        {
            Fates = fates;
        }
        ...
        public static EurekaHydatos GetTracker()
        {
            List<EurekaFate> HydatosFates = new()
            {
                ...
                new(
                    ...
                    "Stegodon",
                    "Stegodon",
                    new Vector2(10.1f, 17.9f),
                    "Hydatos Primelephas",
                    new Vector2(11.1f, 16.0f),
                    EurekaWeather.None,
                    EurekaWeather.None,
                    EurekaElement.Earth,
                    EurekaElement.Earth,
                ...
                new(
                    ...
                    "Frostmane",
                    "Frostmane",
                    new Vector2(7.9f, 26.1f),
                    "Northern Tiger",
                    new Vector2(6.4f, 26.5f),
                    EurekaWeather.None,
                    EurekaWeather.None,
                    EurekaElement.Fire,
                    EurekaElement.Earth,
                ...
                new(
                    ...
                    "King Goldemar",
                    "Golde",
                    new Vector2(28.9f, 23.6f),
                    "Hydatos Wraith",
                    new Vector2(28.0f, 23.0f),
                    EurekaWeather.None,
                    EurekaWeather.None,
                ...
                new(
                    ...
                    "Leuke",
                    "Leuke",
                    new Vector2(37.0f, 26.0f),
                    "Tigerhawk",
                    new Vector2(37.2f, 27.8f),
                    EurekaWeather.None,
                    EurekaWeather.None,
                    EurekaElement.Earth,
                    EurekaElement.Wind,
                ...
                new(
                    ...
                    "Provenance Watcher",
                    "PW",
                    new Vector2(32.7f, 19.6f),
                    "Crystal Claw",
                    new Vector2(32.5f, 21.6f),
                    EurekaWeather.None,
                    EurekaWeather.None,
                    EurekaElement.Fire,
                    EurekaElement.Fire,
