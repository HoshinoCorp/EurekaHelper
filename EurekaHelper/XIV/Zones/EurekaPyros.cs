...
namespace EurekaHelper.XIV.Zones
{
    public class EurekaPyros : IEurekaTracker
    {
        ...
        public EurekaPyros(List<EurekaFate> fates)
        {
            Fates = fates;
        }
        ...
        public static EurekaPyros GetTracker()
        {
            List<EurekaFate> PyrosFates = new()
            {
                ...
                new(
                    ...
                    "Askalaphos",
                    "Owl",
                    new Vector2(19.2f, 29.2f),
                    "Overdue Tome",
                    new Vector2(19.2f, 29.2f),
                    EurekaWeather.UmbralWind,
                    EurekaWeather.None,
                    EurekaElement.Wind,
                    EurekaElement.Earth,
                    false,
                ...
                new(
                    ...
                    "Skoll",
                    "Skoll",
                    new Vector2(24.0f, 30.0f),
                    "Pyros Shuck",
                    new Vector2(16.0f, 36.8f),
                ...
                new(
                    ...
                    "Penthesilea",
                    "Penny",
                    new Vector2(35.9f, 5.9f),
                    "Val Bloodglider",
                    new Vector2(33.6f, 8.2f),
