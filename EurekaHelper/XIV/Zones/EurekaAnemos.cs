...
namespace EurekaHelper.XIV.Zones
{
    public class EurekaAnemos : IEurekaTracker
    {
        ...
        public EurekaAnemos(List<EurekaFate> fates)
        {
            Fates = fates;
        }
        ...
        public static EurekaAnemos GetTracker()
        {
            List<EurekaFate> AnemosFates = new()
            {
                ...
                new(
                    ...
                    "Pazuzu",
                    "Paz",
                    new Vector2(7.4f, 21.6f),
                    "Shadow Wraith",
                    new Vector2(8.6f, 20.2f),
                    EurekaWeather.Gales,
                    EurekaWeather.None,
                    EurekaElement.Wind,
                    EurekaElement.Fire,
